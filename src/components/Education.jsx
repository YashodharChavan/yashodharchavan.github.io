...
const RedirectComponent = ({ name }) => {
    ...
    const handleAcademicResultClick = (id) => {
        console.log('handleAcademicResultClick called with id:', id);
        const result = academicResults.find(res => res.id === id.trim().toLowerCase());
        if (result) {
            console.log('Opening Safari with:', result.id, result.href);
    ...
    return (
        ...
        <button
            onClick={(e) => {
                ...
                handleAcademicResultClick(name);
            }}
            className="bg-white hover:bg-[#A2B2CA] w-full min-w-[90px] h-4/5 rounded-2xl flex items-center cursor-pointer gap-x-1"
            style={{ padding: '4px 8px' }}
        >
            <img loading="lazy" src={genericDocument} alt="" className="h-7 w-fit" />
            <p className="text-sm">Result</p>
            {/* <i  mg loading="lazy" src={redirect} alt="" /> */}
        </button>
    );
};
...
const Education = ({scrollRef}) => {
    ...
    return (
        <div className="min-h-screen w-full bg-[#ECF2F9]">
            <div className="topbar font-bold text-lg sm:text-xl" style={{ padding: '12px 24px' }}>
                Yashodhar
            </div>
            <hr className="gradient-hr" />
            <div
                className="landing-container w-full relative bg-[#ECF2F9] background-inset"
            ...
            >
                <div className="introduction m-auto w-full h-full py-8 sm:py-16 flex flex-col items-center justify-center gap-4 sm:gap-6">
                    <h1 className="text-4xl font-bold text-center">I ❤️ Education</h1>
                    <p className="w-full text-center text-base font-medium">
                        I always love to learn. Learning is the only difference between today and tomorrow 😇
                    </p>
                    <div
            ...
            <hr className="gradient-hr" />
            <h1
                className="text-3xl font-bold mb-6 sm:mb-8 text-center underline decoration-wavy decoration-red-500"
            ...
            <table className="w-[90%]" style={{ margin: '0px auto 32px auto' }}>
                <thead>
                    <tr style={{ backgroundColor: '#f3f4f6' }}>
                        <th className="border border-gray-300" style={{ padding: '8px 16px' }}>
                            Year
                        </th>
                        <th className="border border-gray-300" style={{ padding: '8px 16px' }}>
                            Grade
                ...
                <tbody>
                    ...
                    <tr className="bg-white">
                        ...
                        <td className="border border-gray-300" style={{ padding: '8px 16px' }}>
                            <RedirectComponent name="1st Semester Result" />
                        </td>
                    </tr>
                    <tr className="bg-white">
                        <td className="border border-gray-300" style={{ padding: '8px 16px' }}>
                        ...
                        <td className="border border-gray-300" style={{ padding: '8px 16px' }}>
                            <RedirectComponent name="2nd Semester Result" />
                        </td>
                    </tr>
                    <tr className="bg-white">
                        <td className="border border-gray-300" style={{ padding: '8px 16px' }}>
                        ...
                        <td className="border border-gray-300" style={{ padding: '8px 16px' }}>
                            <RedirectComponent name="3rd Semester Result" />
                        </td>
                    </tr>
                    <tr className="bg-white">
                        <td className="border border-gray-300" style={{ padding: '8px 16px' }}>
            ...
            <hr className="gradient-hr" />
            <h1
                className="text-3xl font-bold mb-6 sm:mb-8 text-center underline decoration-wavy decoration-purple-600"
                style={{ padding: '24px 0px' }}
            >
                My Favourite Books:
            </h1>
